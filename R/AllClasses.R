...
setOldClass("curl_handle")
setOldClass("xml_document")

##
## Class for NEOS communication objects
##
setClass("NeosComm", representation(url = "character", curlopts = "list", curlhandle = "curl_handle"))
##
...
##
setClass("NeosXml", representation(xml = "xml_document", method = "character", call = "call", nc = "NeosComm"))
##
